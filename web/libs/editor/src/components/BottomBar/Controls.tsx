...
export const EMPTY_SUBMIT_TOOLTIP = "此项目中拒绝空标注";
export const INCOMPLETE_SUBMIT_TOOLTIP = "提交前请填写所有区域";
export const INCOMPLETE_UPDATE_TOOLTIP = "更新前请完成所有区域";
export const INCOMPLETE_ACCEPT_TOOLTIP = "在接受之前完成所有区域";
      ...
      rejectButtons.forEach((button) => {
        ...
        const onReject = async (e: React.MouseEvent) => {
          ...
          if (store.hasInterface("comments:reject")) {
            handleActionWithComments(e, action, "拒绝前请填写评论");
          } else {
            selected?.submissionInProgress();
