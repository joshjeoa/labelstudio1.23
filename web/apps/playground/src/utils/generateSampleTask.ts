  ...
  valueNodes.forEach((node) => {
    ...
    if (tag === "paragraphs") {
      ...
      if (value?.toLowerCase().includes("humanmachinedialogue")) {
        data[key] = [
          { [nameKey]: "人类", [textKey]: "、示例：嗨，机器人！" },
          { [nameKey]: "机器人", [textKey]: "示例：很高兴见到你，人类！告诉我你想要什么。" },
          { [nameKey]: "人类", [textKey]: "示例：帮我从格林街的金男孩餐厅订一份披萨" },
          { [nameKey]: "机器人", [textKey]: "示例：已完成。您想什么时候拿到订单？" },
          { [nameKey]: "人类", [textKey]: "示例：凌晨3点，请" },
        ];
      } else {
        data[key] = [
          { [nameKey]: "Alice", [textKey]: "示例：Text #1" },
          { [nameKey]: "Bob", [textKey]: "示例：Text #2" },
          { [nameKey]: "Alice", [textKey]: "示例：Text #3" },
          { [nameKey]: "Bob", [textKey]: "示例：Text #4" },
          { [nameKey]: "Alice", [textKey]: "示例：Text #5" },
        ];
      }
      return;
    }
    ...
    if (tag === "table") {
      data[key] = { "Card number": 18799210, "First name": "示例", "Last name": "Text" };
      return;
    }
      ...
      data[key] = [
        {
          ...
          children: [
            { value: "子类别 1.1" },
            { value: "子类别 1.2", children: [{ value: "子类别 1.2.1" }, { value: "子类别 1.2.2" }] },
          ],
        },
        { value: "类别 2" },
        { value: "类别 3", children: [{ value: "子类别 3.1" }, { value: "子类别 3.2" }] },
      ];
    } else if (tag === "html") {
      data[key] = "<b>示例HTML内容</b>";
    } else if (tag === "rating") {
      data[key] = 4;
    } else if (tag === "number") {
      data[key] = 42;
