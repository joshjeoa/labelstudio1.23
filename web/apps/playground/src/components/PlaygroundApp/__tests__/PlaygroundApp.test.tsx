  ...
  describe("PlaygroundApp: Loads configs from v1 URL", () => {
    it.each([
      ...
      <View style=\"display: grid;  grid-template-columns: 1fr 1fr 1fr; max-height: 300px; width: 400px\">
        <TextArea name=\"table_name_1\" toName=\"image\" placeholder=\"名称\" editable=\"true\" maxSubmissions=\"1\"/>
        <TextArea name=\"table_value_1\" toName=\"image\" placeholder=\"值\" editable=\"true\" maxSubmissions=\"1\"/>
        <TextArea name=\"table_metric_1\" toName=\"image\" placeholder=\"指标\" editable=\"true\" maxSubmissions=\"1\"/>
        <TextArea name=\"table_name_2\" toName=\"image\" placeholder=\"名称\" editable=\"true\" maxSubmissions=\"1\"/>
        <TextArea name=\"table_value_2\" toName=\"image\" placeholder=\"值\" editable=\"true\" maxSubmissions=\"1\"/>
        <TextArea name=\"table_metric_2\" toName=\"image\" placeholder=\"指标\" editable=\"true\" maxSubmissions=\"1\"/>
        <TextArea name=\"table_name_3\" toName=\"image\" placeholder=\"名称\" editable=\"true\" maxSubmissions=\"1\"/>
        <TextArea name=\"table_value_3\" toName=\"image\" placeholder=\"值\" editable=\"true\" maxSubmissions=\"1\"/>
        <TextArea name=\"table_metric_3\" toName=\"image\" placeholder=\"指标\" editable=\"true\" maxSubmissions=\"1\"/>
      </View>
    </View>`,
      },
      {
