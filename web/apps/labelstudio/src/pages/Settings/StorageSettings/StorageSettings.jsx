    ...
    <section className="max-w-[680px]">
      ...
      {hasAnyStorages && (
        <Typography size="small" className="text-neutral-content-subtler mb-wider">
          将云存储或数据库存储用作您的标注任务的源数据或已完成标注的目标。
        </Typography>
      )}
      ...
      {!hasAnyStorages && isLoaded && !isLoading && (
        <SimpleCard title="" className="bg-primary-background border-primary-border-subtler p-base">
          <EmptyState
            ...
            title="添加您的第一个云存储"
            description="使用云端或数据库存储作为您标注任务的来源或已完成标注的目标。"
            additionalContent={
              <div className="flex items-center justify-center gap-base" data-testid="dm-storage-provider-icons">
                <Tooltip title="亚马逊S3">
                  <div className="flex items-center justify-center p-2" aria-label="亚马逊S3">
                    <IconCloudProviderS3 width={32} height={32} className="text-neutral-content-subtler" />
                  </div>
                </Tooltip>
                <Tooltip title="Google云存储">
                  <div className="flex items-center justify-center p-2" aria-label="Google云存储">
                ...
                <Tooltip title="Redis存储">
                  <div className="flex items-center justify-center p-2" aria-label="Redis存储">
